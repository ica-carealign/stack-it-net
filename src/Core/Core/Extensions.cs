...
namespace Ica.StackIt.Core
{
	public static class Extensions
	{
		...
		///     <remarks>
		///         Uses <see cref="string.Format(string,object)" /> internally; custom formats should match those used for
		///         that method.
		///     </remarks>
		/// </summary>
		...
		/// <summary>
		///     Replaces all instances of a 'key' (e.g. {foo} or {foo:SomeFormat}) in a string with an optionally formatted value,
